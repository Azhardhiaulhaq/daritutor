...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="myModal" class="modal">
            ...
            <div class="text--large block--skyblue text--bold modal-text">Payment Success</div>
            <div class="text--medium text--bold modal-text">Thank you for purchasing! You can view your purchase now</div>
            <div id="va" class="text--medium text--bold modal-text"></div>
            <div id="tranid" class="text--medium text--bold modal-text"></div>
            <button onclick="location.href = '/history'" type="submit" value="Submit" form="form1" class="btn btn-transaction">Go to transaction history</button>
        </div>
        </div>
